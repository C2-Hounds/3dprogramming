...
#include"Object/Earth/Moon/Moon.h"
// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// /////
// エントリーポイント
// アプリケーションはこの関数から進行する
// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// /////
...
void Application::Update()
{
	...
	Math::Matrix _mStandRotationX = Math::Matrix::CreateRotationX(DirectX::XMConvertToRadians(90));
	...
	Math::Matrix _transamat = Math::Matrix::CreateTranslation(0, 35, 0);
	//カメラの「ワールド行列」を生成し、適応させる
	Math::Matrix _worldMat = (_scalemat * _mStandRotationX * _transamat);//<-行列の合成(1年の時に習ったやつ)
